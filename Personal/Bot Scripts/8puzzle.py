...
class EightPuzzle:
    ...
    def __init__(self):
        ...
        for i in range(len(x)):
            temp.append(int(x[i]))
        self.adj_matrix.append(temp[:3])
        self.adj_matrix.append(temp[3:6])
        self.adj_matrix.append(temp[6:])
        self._blank = int(input('blank: '))
